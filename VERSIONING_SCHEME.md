...
La convención consiste en un *Versionamiento Semántico (SEM Ver),* el cual utiliza un **sistema numérico** y **etiquetas de estabilidad** para declarar la madurez del producto.

> **NOTA**: Considere que estas convenciones no son estrictamente de algún estándar oficial, sino que es el resultado de diferentes investigaciones. Usted mismo es libre de implementar la conveción de versionamiento, acorde a sus necesidades. 
